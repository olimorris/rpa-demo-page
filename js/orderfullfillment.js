const templateConfigData = {
  ...
  footerLinks:
    "<a href='https://community.automationanywhere.com/'>Pathfinder Community</a> | <a href='https://university.automationanywhere.com/'>Automation Anywhere University</a>",
  footerBackgroundColor: "#ffffff",
  footerColor: "#5a5a5a",
};
document.querySelector("#footer-text").innerHTML =
  `${templateConfigData.footerText}`;
document.querySelector("#footer-links").innerHTML =
  templateConfigData.footerLinks;
document.querySelector(".footer").style.backgroundColor =
  templateConfigData.footerBackgroundColor;
